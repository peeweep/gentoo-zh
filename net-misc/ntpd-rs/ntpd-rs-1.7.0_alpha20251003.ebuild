...
SRC_URI="
	${CARGO_CRATE_URIS}
	https://github.com/pendulum-project/ntpd-rs/archive/refs/tags/v${MY_PV}.tar.gz -> ${P}.tar.gz
	https://github.com/gentoo-zh-drafts/ntpd-rs/releases/download/v${MY_PV}/${PN}-${MY_PV}-crates.tar.xz
"

S="${WORKDIR}/${PN}-${MY_PV}/ntpd"
